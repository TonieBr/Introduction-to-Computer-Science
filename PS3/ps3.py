...
def get_word_score(word, n):
    ...
    if 1 > secondComponent:
        score = score * 1
    else: 
        score = score * secondComponent
...
def update_hand(hand, word):
    ...
    for letter in newHand.keys():
        if newHand[letter] > 0:
            returnHand[letter] = returnHand.get(letter, 0) + newHand[letter]
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while True:
        ...
        if not is_valid_word(userInput, hand, word_list):
            continue
        
        word_score = get_word_score(userInput, calculate_handlen(hand))
        SCORE = SCORE + word_score
        
        print(userInput, 'earned', word_score)
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    gameCount = int(input('Enter total number of hands: '))
    ...
    while gameCount > 0:
        ...
        toReplace = input('Would you like to substitute a letter? ')
        
        if toReplace == 'Yes' or toReplace == 'yes':
